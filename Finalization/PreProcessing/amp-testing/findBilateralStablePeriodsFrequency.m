function [stable_periods,stim_params_left,stim_params_right,condition,left_plats,right_plats] =findBilateralStablePeriodsFrequency(ampc1,ampc2,datc1,datc2)
%%
prompt = 'Enter clinical frequency on left: ';
clin_freq_left = input(prompt);

prompt = 'Enter clinical frequenct on right: ';
